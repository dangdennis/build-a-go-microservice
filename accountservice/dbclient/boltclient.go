...
import (
	...
	"github.com/dangdennis/build-a-go-microservice/accountservice/model"
)

// IBoltClient is our client contract
...
// BoltClient is the actual client
type BoltClient struct {
	boltDB *bolt.DB
}

// OpenBoltDb inits our DB
...
// Seed bootstraps some account in the db
...
// QueryAccount fetches an account
